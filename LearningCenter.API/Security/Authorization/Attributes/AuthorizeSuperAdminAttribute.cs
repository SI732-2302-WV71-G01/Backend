...
public class AuthorizeSuperAdminAttribute : Attribute, IAuthorizationFilter
{
    public void OnAuthorization(AuthorizationFilterContext context)
    {
        ...
        else
        {
            ...
            if (user == null || user.Role.Name == "Inexpert" || user.Role.Name == "Expert") //If there is no user or the user has role of USER or the role of EXPERT
